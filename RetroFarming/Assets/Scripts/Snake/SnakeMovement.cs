...
public class SnakeMovement : MonoBehaviour
{
    ...
    /*EASTER EGG*/
    public bool inSpecialMode;
    public RuntimeAnimatorController poussinSpecial;
    public RuntimeAnimatorController pouleSpeciale;
    ...
    public void resetIntoEasterEgg()
    {
        inSpecialMode = true;
        gridPosition = new Vector2Int(10, 10);
        gridMoveTimerMax = .2f;
        ...
        /*Change animator poule*/
        snakeBody = GetComponent<Animator>();
        snakeBody.GetComponent<Animator>().runtimeAnimatorController = pouleSpeciale as RuntimeAnimatorController;
        snakeBody.SetFloat("Horizontal", 1);
        snakeBody.SetFloat("Vertical", 0);

        /*Spawn new food*/
        levelGrid.changeFood();

        /*Destoy all old poussins*/
        GameHandler.removePoussins();
    ...
    private class SnakeBodyPart
    {
        ...
        public SnakeBodyPart(int index, SnakeMovement chicken)
        {
            ...
            if (chicken.inSpecialMode)
            {
                snakeBody.GetComponent<Animator>().runtimeAnimatorController = chicken.poussinSpecial as RuntimeAnimatorController;
            }
            else
            {
